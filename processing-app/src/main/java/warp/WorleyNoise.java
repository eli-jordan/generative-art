/*
 * Copied from https://raw.githubusercontent.com/saybur/fractala/master/fractala/src/com/tarvon/fractala/noise/CellularNoise.java
 */
...
public final class WorleyNoise {
   ...
   public float noise(float x, float y, float z) {
      return (float) calculate(x, y, z);
   }

   public float noise(float x, float y) {
      return (float) calculate(x, y, 0);
   }
}
